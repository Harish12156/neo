                ...
                <div className='col-xl-6'>
                    <div className="card dash-card-1">
                        <div className="card-body">
                            ...
                            <div className='row g-3 row-cols-lg-4 row-cols-md-4 row-cols-2 quick-action-sec mb-2'>
                            ...
                            <div className='row g-3 quick-action-sec'>
                                <div className='col col-p'>
                                ...
                                <div className='col-lg-9'>
                                    <div className='row desk-h-100 g-3'>
                                        <div className='col-6 desk-h-100 col-p'>
