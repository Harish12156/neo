...
function Settings() {
  const series = [25.6, 32, 23.8, 9.9, 8.7];
  const options = {
    chart: {
      type: 'donut',
    },
  ...
  return (
    <div className=''>
      <div className='container-fluid p-4'>
        <div className='row '>
          <div className='col-md-8 epic-chart-sec-01 py-2 '>

            <div className='new-epic-whole-top '>
              <div className='row mb-3 epic-chart-sec-00 '>
                <p className='mb-auto py-3 epic-rounds-up'>Rounds Up</p>
              ...
              <div className='row epic-united-states-whl-001 py-3 px-2 epic-chart-sec-00'>
                <div className='col-lg-6'>
                  <p className='epic-helps-support'>Help & supports </p>
          ...
          <div className='col-md-4 '>
            <div className='epic-total-referral-box py-4 px-2'>
              ...
              <p className='epic-share-full-ctn mb-5'>Share your unique referral code which is your Rempic ID, or share
